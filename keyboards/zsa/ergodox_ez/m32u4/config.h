...
<<<<<<< HEAD:keyboards/zsa/ergodox_ez/m32u4/config.h
...
#define ERGODOX_LED_2_PIN B6
#define ERGODOX_LED_3_PIN B7

#define ERGODOX_LED_SHUTOFF_PIN D6
=======
#undef PRODUCT_ID
...
>>>>>>> firmware21:keyboards/ergodox_ez/glow/config.h
